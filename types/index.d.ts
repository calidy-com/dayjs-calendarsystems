...
export type CalendarSystem = 'gregory' | 'persian' | 'jalali' | 'jalaali' | 'shamsi' | 'khorshidi' | 'islamic' | 'islamic-civil' | 'islamic-rgsa' | 'islamic-tbla' | 'islamic-umalqura' | 'islamicc' | 'hijri' | 'arabic' | 'ghamari' | 'hebrew' | 'jewish';
